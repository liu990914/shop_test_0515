...
<head>
	...
	<script type="text/javascript">
		$(function () {
			var cid = "${cid}";
			$.get("${pageContext.request.contextPath}/findallcategory.do",function (data) {
				str = "";
				for(i=0;i<data.length;i++){
					if(cid-1 == i){
						str+="<li class=\"active\"><a href='${pageContext.request.contextPath}/findproduct.do?cid="+data[i].cid+"'>"+data[i].cname+"</a></li>";
					}else {
						str+="<li><a href='${pageContext.request.contextPath}/findproduct.do?cid="+data[i].cid+"'>"+data[i].cname+"</a></li>";
					}
				}
				$("#category").html(str);
			},"json")
	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<form action="${pageContext.request.contextPath}/findproduct.do" method="get" class="navbar-form navbar-right" role="search">
					<div class="form-group">
						<!-- 要在cid分页查询的基础上进行模糊查询，所以在模糊查询的时候要把cid一起提交-->
...
<div class="row" style="width:1210px;margin:0 auto;">
	...
	<c:forEach items="${pb.lists}" var="product">
		<div class="col-md-2">
...
<div style="width:380px;margin:0 auto;margin-top:50px;">
	<ul class="pagination" style="text-align:center; margin-top:10px;">
		<c:choose>
			...
			<c:otherwise>
				<li ><a href="${pb.url}&nowpage=${pb.nowpage-1}" aria-label="Previous">
					<span aria-hidden="true">&laquo;</span></a>
				</li>
			</c:otherwise>
		</c:choose>
