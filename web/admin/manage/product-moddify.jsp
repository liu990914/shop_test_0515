...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>修改商品</h2>
		<div class="manage">
			<form action="${pageContext.request.contextPath}/updateproduct.do" method="post"  enctype="multipart/form-data">
				<input  type="hidden" name="pid" value="${product.pid }"/>
				<table class="form">
					<tr>

						<td colspan="2">商品名称：<input type="text" class="text" name="pname" value="${product.pname }" /></td>
					</tr>
					<tr>
						<td colspan="2">
					...
					<tr>
						<td colspan="2">商品图片：<input type="file" class="text" name="pimage" value="${product.pimage}" /></td>
					</tr>
					<tr>
						<td colspan="2">市场价格：<input type="text" class="text tiny" name="market_price" value="${product.market_price }" /> 元</td>
					</tr>
					<tr>
						<td colspan="2">商品价格：<input type="text" class="text tiny" name="shop_price" value="${product.shop_price }" /> 元</td>
					</tr>
					<tr>
						<td colspan="2" >详细描述：</td>
					</tr>
					<tr>
						<td ><textarea name="pdesc"  cols="100" rows="8" style="width:700px;height:200px;visibility:hidden;">${product.pdesc}<%=htmlspecialchars(htmlData)%></textarea></td>
					</tr>
					<tr>
						<td></td>
